...
const Tests = () => {
  ...
  const handleTakeTest = (testId) => {
    console.log('Tests - Navigating to test:', testId);
  };
              ...
              <div key={test._id} style={{
                ...
                <Link
                  ...
                  style={{
                    ...
                    color: '#FFFFFF',
                    textDecoration: 'none',
                    backgroundColor: isAvailable ? '#D4A017' : '#E0E0E0',
                    cursor: isAvailable ? 'pointer' : 'not-allowed'
                  }}
                  onMouseOver={e => {
                    if (isAvailable) e.currentTarget.style.backgroundColor = '#F5F5F5';
                    if (isAvailable) e.currentTarget.style.color = '#4B5320';
                  }}
                  onMouseOut={e => {
                    if (isAvailable) e.currentTarget.style.backgroundColor = '#D4A017';
                    if (isAvailable) e.currentTarget.style.color = '#FFFFFF';
                  }}
                >
